...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\营烬\\Desktop\\实验_psychopy\\untitled_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials_3 = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('C:/Users/营烬/Desktop/实验表格/altruism_High.xlsx'), 
        seed=10, 
    )
    ...
    for thisTrial_3 in trials_3:
        ...
        practise_time_limited = data.Routine(
            ...
            components=[Title_L, Self_L, Others_L, Title_R, Self_R, Others_R, key_prac_limited, worn],
        )
    ...
    trials_4 = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('C:/Users/营烬/Desktop/实验表格/altruism_Low.xlsx'), 
        seed=10, 
    )
