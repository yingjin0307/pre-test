...
function start_wordRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of start_wordComponents)
...
function practise_instructionRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practise_instructionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function 练习_时间限制指导语RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of 练习_时间限制指导语Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practise_time_limitedRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practise_time_limitedComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function worn_page_pracRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of worn_page_pracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function 练习_非时间限制指导语RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of 练习_非时间限制指导语Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function prac_time_none_limitedRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of prac_time_none_limitedComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function 实验_正式实验指导语RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of 实验_正式实验指导语Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function 实验_时间限制指导语RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of 实验_时间限制指导语Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Trail_loop_limitedRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Trail_loop_limitedComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function worn_pageRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of worn_pageComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function 间歇休息RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of 间歇休息Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function 实验_非时间限制指导语RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of 实验_非时间限制指导语Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Trail_loop_no_limitedRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Trail_loop_no_limitedComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function end_wordRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of end_wordComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
